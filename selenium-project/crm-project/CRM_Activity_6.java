...
public class CRM_Activity_6 {
	...
	@Test(priority = 1)
	public void actTextPresent() throws InterruptedException {
		testLogin();
		WebElement activitiesText = driver.findElement(By.xpath("//a[@id='grouptab_3']"));
		String actText = activitiesText.getText();
		System.out.println("Activities text is: " + actText);
		boolean actTxtPresent = activitiesText.isDisplayed();
		System.out.println("Activities text is present: " + actTxtPresent);
		
		activitiesText.click();
	    Thread.sleep(5000);
	}
