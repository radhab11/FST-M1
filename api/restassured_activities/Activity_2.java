...
public class Activity_2 {
	...
	public void addNewUserFromFile() throws IOException {
		FileInputStream inputJSON = new FileInputStream("src/test_Activities/userinfo.json");
	...
	public void getUserInfo() {
		File outputJSON = new File("src/test_Activities/userGETResponse.json");
		...
		Response response1 = 
				given().contentType(ContentType.JSON) 
				.pathParam("username", "Radhab11")
				.when().get(ROOT_URI + "/{username}"); 
		String resBody = response.getBody().asPrettyString();
		String resBody1 = response1.getBody().asPrettyString();
